...
images, extrinsics, intrinsics, depthmaps, masks, depth_indices, camera_indices =  load_images_and_cameras_processOGimages(
        image_folder="example/nuscenesTmp1OG/037020f_018", # 447000b 037020f 037020f_018
...
## 验证depth_indices和camera_indices
print("depth_indices:", depth_indices)             # depth_indices: tensor([0])
print("camera_indices:", camera_indices)           # camera_indices: tensor([0, 1, 2])
# camera_indices = []
# print("camera_indices:", camera_indices)           # camera_indices: tensor([0, 1, 2])
...
print("inputs depth:", inputs['depth'].shape)  # inputs depth: torch.Size([1, 3, 294, 518, 1])
print("input mask:", inputs['mask'].shape)    # input mask: torch.Size([1, 3, 294, 518, 1])
...
image_names = "037020f_018_wFirstPoseInj_32_518"     
